...
export default function CreateProfilPage() {
  ...
  useEffect(() => {
    ...
    // Log whether the profile has been created
    console.log('CREATEDPROFILE', createdProfile);

    // Check if user data exists and all required fields are filled, and if the profile has been created
    if (
      user &&
      user.firstname &&
      user.lastname &&
      ...
      // If all conditions are ok  navigate to the dashboard
      navigate('/');
    }
        ...
        <div className="containerSign__mainSign">
          ...
          <form
            ...
            onSubmit={(e) => {
              ...
              if (firstname && lastname && phone_number && birthdate) {
